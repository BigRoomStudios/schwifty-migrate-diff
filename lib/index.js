...
exports.genMigrationFile = (options, cb) => {
    ...
    (_) => {
        ...
        console.log('joinTableCollector', joinTableCollector);
        ...
        const joinTables = joinTableCollector.reduce((collector, joinTable) => {
            ...
            if (!collector[tableName]) {
                ...
                // Merge the joiSchema and knexSchema
        ...
        internals.diffTables(migrationGroup, joinTables, allTables, userOptions.mode, (_tableErr, tableDeltas) => {

            internals.diffColumns(migrationGroup, joinTables, userOptions.mode, (columnsErr, columnDeltas) => {

                if (columnsErr) {
                    return cb(columnsErr);
                }
                        ...
                        case 'create':
                            ...
                            if (tableType === 'tableDelta') {
                                ...
                                if (deltaObj[tableType].create.indexOf(currentItem) === lastIndex) {
                                    ...
                                    // Altering tables not yet supported
                                ...
                                if (deltaObj[tableType].create.indexOf(currentItem) === lastIndex &&
                                    ...
                                    // Table dropping not yet supported
                                    // if (Object.keys(deltaObj[tableType].alter).length === 0 &&
                                    //     deltaObj[tableType].drop.length === 0) {
                                    if (Object.keys(deltaObj[tableType].alter).length === 0) {
...
// TODO This is fubar, need to make this better async and return the correct results
