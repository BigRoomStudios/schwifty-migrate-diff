...
exports.genMigrationFile = (options, schwiftyMigrationNext) => {
    ...
    internals.diffTables(migrationGroup, joinTables, allTables, (_, tableDeltas) => {

        internals.diffColumns(migrationGroup, (_, columnDeltas) => {
            ...
            Handlebars.registerHelper('sort', (arr) => {
            ...
            console.log('columnDeltas', columnDeltas);
