...
exports.genMigrationFile = (options, schwiftyMigrationNext) => {
    ...
    internals.diffTables(migrationGroup, userOptions.mode, joinTables, allTables, (_tableErr, tableDeltas) => {

        internals.diffColumns(migrationGroup, userOptions.mode, (_columnsErr, columnDeltas) => {
            ...
            Handlebars.registerHelper('tableMaybeSemi', (step, currentItem, deltaObj, columnDeltaObj, tableType) => {
                ...
                // console.log('columnDeltaObj.changes.alter', columnDeltaObj.changes);
                // const nonCreateChanges = Object.keys(columnDeltaObj.changes.alter).length !== 0 ||
                //                          columnDeltaObj.changes.drop.length !== 0;
                    ...
                    case 'create':
                        ...
                        if (tableType === 'tableDelta') {
                            ...
                            if (deltaObj[tableType].create.indexOf(currentItem) === lastIndex) {
                                ...
                                if (Object.keys(deltaObj[tableType].alter).length === 0 &&
                                    deltaObj[tableType].drop.length === 0 &&
                                    deltaObj.joinTableDelta.create.length === 0 &&
                                    Object.keys(deltaObj.joinTableDelta.alter).length === 0 &&
                                    deltaObj.joinTableDelta.drop.length === 0 &&
            ...
            Handlebars.registerHelper('semi', (step, currentItem, deltaObj, tableType) => {
                ...
                switch (step) {
                    ...
                    case 'alter':
                        ...
                        console.log('currentItemIndex === lastIndex', currentItemIndex === lastIndex);

                        if (currentItemIndex === lastIndex &&
                            Object.keys(currentItem.alter).length === 0 &&
                            currentItem.drop.length === 0) {
            ...
            if (createdTables.length === 0 &&
                ...
                return schwiftyMigrationNext(null, 'No migration needed');
            }
            ...
            migrationGroup.knex.migrate.make(userOptions.migrationName || 'schwifty-migration', {
                ...
                .then(() => {
                    ...
                    return schwiftyMigrationNext(null, justCreatedMigrationPath);
                });
        });
    });
};

internals.diffTables = (migrationGroup, mode, joinTables, allTables, cb) => {
...
internals.diffColumns = (migrationGroup, mode, cb) => {
