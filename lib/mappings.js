...
const maps = {
    joiKnexMap: {
        ...
        binary        : 'binary',
        number        : 'float',
        numberInteger : 'integer', // numberInteger is a value I created for Joi.number().integer()
        array         : 'json',
        object        : 'json',
        any           : 'string'
    },
    knexJoiMap: {
        ...
        binary        : 'binary',
        float         : 'number',
        integer       : 'numberInteger', // numberInteger is a value I created for Joi.number().integer()
