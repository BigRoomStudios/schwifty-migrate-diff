...
const convertFuncs = {
    ...
    joi2Knex: (joiSchema, augmentError) => {
        ...
        return multiReturn(
            ...
            `Joi Schema type(s) "${badChildren}" not supported${augmentError || ''}.`,
            columns
        );
    },
    ...
    db2ColumnCompiler: (dbType, augmentError) => {
