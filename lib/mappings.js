...
module.exports = { maps, convertFuncs };
...
convertFuncs.getAliasVal = (type, augmentError) => {
...
convertFuncs.joi2Knex = (joiSchema, augmentError) => {
...
convertFuncs.knex2JoiType = (knexType) => {
...
convertFuncs.db2ColumnCompiler = (dbType, augmentError) => {

    const [err, foundType] = convertFuncs.getAliasVal(dbType, augmentError);
...
convertFuncs.columnCompiler2Knex = (columnCompilerType) => {
